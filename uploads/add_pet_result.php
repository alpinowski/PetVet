<?php
	...
	if(isset($_FILES['userfile']))
	{
		...
		$targeturl = "../petvet/uploads/files/" . $petid . "_result.pdf";

		if(move_uploaded_file($_FILES["userfile"]['tmp_name'], "../uploads/files/" . $petid . "_result.pdf"))
		{
			$query = "UPDATE pet SET result = '{$targeturl}' WHERE ID = {$petid}";
