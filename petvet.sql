...
values('Mr.', 'Alp Keskin', 'Alp', 'f7c3bc1d808e04732adf679965ccc34ca7ae3441', 'mcaka@mail.com', 1); /*[PASSWORD:123456789]*/
insert into users (prefix, fullname, username, u_password, email, fk_role_id)
values('Ms.', 'Gokcen Ozcelik', 'Gokcen', '6a0129d59aa4967c0627c4c0803ae1a9a49f6ddd', 'gokcen@mail.com', 3); /*[PASSWORD:1312]*/
insert into users (prefix, fullname, username, u_password, email, fk_role_id)
values('Miss', 'Sarah Turner', 'Sarah', '00fd4b4549a1094aae926ef62e9dbd3cdcc2e456', 'susu@mail.com', 2); /*[PASSWORD:1122]*/
...
values('Mr.','Alp Keskin','Istanbul, Turkey','+905345103508','mcak@mail.com');
insert into owners (prefix, fullname, address, mobile, email)
values('Miss','Gokcen Ozcelik','Stockholm, Sweden','+46526587445 ','test@mail.com');
insert into owners (prefix, fullname, address, mobile, email)
values('Mrs.','Sarah Turner','Wroclaw, Poland','+48508596774','s.turner@mail.com');
