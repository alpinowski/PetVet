              ...
              <?php if($arr['insert_p']=="Yes"){ ?>
                <div class="table-toolbar">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="btn-group">
                        <button data-toggle="modal" href="#addmodal" class="btn yellow"> <i class="fa fa-plus"></i> Add user
                        </button>
                      </div>
                    </div>
                  </div>
                ...
                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                  ...
                  <tbody>
                    ...
                    while ($aset = mysqli_fetch_assoc($class_set))
                    {
                      ...
                      echo "<td width='20%'>" . $aset['username'] . "</td>";
                      echo "<td width='20%'>" . $aset['email'] . "</td>";
                      echo "<td width='15%'>" . $aset['r_name'] . "</td>";
                ...
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="input-icon right">
                        <i class="fa"></i>
                      <input type="text" class="form-control" id="afullname" name="afullname" placeholder="ex: John Wick" />
                    </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="input-icon right">
                        <i class="fa"></i>
                        <input class="form-control" id="apassword" name="apassword" placeholder="Password" type="password" />
                      </div>
                    </div>
                  </div>

                  <div class="form-group">
                    <label class="control-label col-md-4">Re-Enter Password
                    </label>
                    <div class="col-md-6">
                      <div class="input-icon right">
                        <i class="fa"></i>
                        <input class="form-control" id="arpass" name="arpass" placeholder="Password" type="password" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="input-icon right">
                        <i class="fa"></i>
                      <input type="text" class="form-control" id="aemail" name="aemail" placeholder="ex: jhon@wick.two" />
                    </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <select class="form-control" id="arole" name="arole">
                        <?php 
                          $class_set = get_roles();
                          while ($aset = mysqli_fetch_assoc($class_set))
                          { echo "<option value=" . $aset['ID'] .">" . $aset['r_name'] . "</option>"; }
                        ?>
                      </select>
                    </div>
                  </div>
                ...
                <div class="form-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="input-icon right">
                        <i class="fa"></i>
                      <input type="text" class="form-control" id="efullname" name="efullname" placeholder="ex: John Wick" />
                    </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="input-icon right">
                        <i class="fa"></i>
                        <input class="form-control" id="epassword" name="epassword" placeholder="Password" type="password" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="input-icon right">
                        <i class="fa"></i>
                        <input class="form-control" id="erpass" name="erpass" placeholder="Password" type="password" />
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div class="input-icon right">
                        <i class="fa"></i>
                        <input type="text" class="form-control" id="eemail" name="eemail" placeholder="ex: jhon@wick.two" />
                      </div>
                    </div>
                  </div>
              ...
              <form class="form-horizontal" role="form">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <p class="form-control-static" id="vusername" name="vusername"> </p>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <p class="form-control-static" id="vrole" name="vrole"> </p>
                  </div>
                </div>
            ...
            <div class="col-md-12">
              <form action="#" class="form-horizontal" id="form_delete">
                <div class="form-body">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <label class="control-label col-md-8">Do you want to delete this user?
                      </label>
                    </div>
                  </div>
                </div>
...
<script src="../petvet/scripts/users/datatables-users.js" type="text/javascript"></script>
<script src="../petvet/scripts/users/crud-users.js" type="text/javascript"></script>
<script src="../petvet/scripts/users/view-users.js" type="text/javascript"></script>
